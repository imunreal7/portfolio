...
const Hero = () => {
  ...
  return (
    <section className="relative mx-auto flex h-screen w-full flex-col items-center justify-center">
      <ParticlesContainer />

      <div className="max-w-10xl flex w-full flex-col items-center justify-between px-1 pt-2 sm:flex-row">
          ...
          <motion.div variants={textVariant()} className="z-10">
            ...
            <p className={`${styles.heroSubText} mt-2 text-white-100`}>
              ...
              <span className="gradient-text">
                I build scalable, enterprise-level applications using MERN
                Stack, Python & AWS
              </span>
            </p>
      ...
      <div className="mb-10 mt-20 flex w-full items-center justify-center">
        <a href="#about">
